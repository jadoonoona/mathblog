...
export const INTEREST_AREAS_KO: InterestArea[] = [
    ...
    { number: '04', title: '앱개발', description: '일상에서 필요한 아이디어를 앱으로 만들고 있습니다. ', topics: ['모바일앱 개발', 'React Native', 'iOS', '제품 설계'], link: '#projects' },
];
...
export const FEATURED_PROJECTS_KO: FeaturedProject[] = [
    ...
    { number: '04', title: 'Our Trip Plan', description: '함께하는 여행 일정을 더 쉽게 계획하기 위해 만든 협업 여행 계획 제품입니다.', tags: ['Mobile', 'React Native', 'Supabase'], link: 'https://ourtripplan.com', linkLabel: '프로젝트 보기' },
];
